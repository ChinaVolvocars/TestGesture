package com.mh.testgesture.widget;
...
import com.mh.testgesture.common.AppUtil;
import com.mh.testgesture.common.Constants;
import com.mh.testgesture.entity.GesturePoint;
...
public class GestureDrawline extends View {
    ...
    public GestureDrawline(Context context, List<GesturePoint> list, boolean isVerify,
        ...
        //线的颜色:#fac6bd   251   210   206
        paint.setColor(Color.rgb(251, 210, 206));// 设置默认连线颜色
    ...
    private void drawErrorPathTip() {
        canvas.drawColor(Color.TRANSPARENT, PorterDuff.Mode.CLEAR);
        //218  52   18
        paint.setColor(Color.rgb(218, 52, 18));// 设置默认线路颜色
        for (Pair<GesturePoint, GesturePoint> pair : lineList) {
